...
var Container = (_dec = (0, _reactRedux.connect)(function (store) {
  ...
  _createClass(Container, [{
    ...
    value: function componentWillMount() {
      ...
      console.log('id from willmount', Number.isInteger(id));;
      var shared = this.props.location.search;
      console.log(shared);
      var copySharedFiles = _extends({}, this.props.sharedFiles);
      var copyFetchedFiles = _extends({}, this.props.ownedFiles);
...
//# sourceMappingURL=0.048d674f4193e77611a0.hot-update.js.map