...
var fileDND = (_dec = (0, _reactRedux.connect)(function (store) {
  ...
  _createClass(fileDND, [{
    ...
    value: function handleDrop(e) {
      ...
      (0, _helperFunctions2.default)(file, function (s) {
        obj.data = s.split('\r\n');
        that.props.dispatch(fileActions.createFile(JSON.stringify(obj)));
      });
    }
  }, {
    key: 'handleDragOver',
...
//# sourceMappingURL=0.32c798a262d15d7d9386.hot-update.js.map