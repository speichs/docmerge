...
var fileDND = (_dec = (0, _reactRedux.connect)(function (store) {
  ...
  _createClass(fileDND, [{
    ...
    value: function handleDrop(e) {
      ...
      if (!this.props.dndName) {
        this.props.reveal = true;
      } else {
        console.log('data_transfer', e.dataTransfer.items[0].getAsFile());
        ...
        _papaparse2.default.parse(file, {
          ...
          complete: function complete(results) {
            ...
            that.props.dispatch(fileActions.createFile(obj, that.props.dndName));
          }
        });
      }
    }
...
//# sourceMappingURL=0.353ca4786cecee483b17.hot-update.js.map