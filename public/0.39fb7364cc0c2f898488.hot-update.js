...
var MyProjects = (_dec = (0, _reactRedux.connect)(function (store) {
  ...
  _createClass(MyProjects, [{
    ...
    value: function render() {
      ...
      var name = JSON.stringify(this.props.ownedFiles[0]);
      var trueName = JSON.parse(name);
      var finalName = trueName.name;
...
//# sourceMappingURL=0.39fb7364cc0c2f898488.hot-update.js.map