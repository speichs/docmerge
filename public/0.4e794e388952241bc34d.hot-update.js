...
function setCurrentProject(obj) {
  return { type: "SET_CURRENT_PROJECT", payload: obj };
}
    ...
    value: function componentWillMount() {
      ...
      if (!id) {} else if (shared === "?false") {
        this.props.ownedFiles.map(function (e) {
          if (e.id === id) {
            _this2.props.dispatch(fileActions.setCurrentProject(e));
          }
        });
      } else if (shared === "?true") {
      ...
      // let copySharedFiles = {...this.props.sharedFiles}
      // let copyFetchedFiles = {...this.props.ownedFiles}
      // this.props.dispatch(fileActions.getCurrentFile(id,shared, copySharedFiles, copyFetchedFiles))
    }
  }, {
...
//# sourceMappingURL=0.4e794e388952241bc34d.hot-update.js.map