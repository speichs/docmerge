  ...
  _createClass(Container, [{
    ...
    value: function onComponentWillMount() {
      ...
      if (this.props.location.search === "?true") {
        ...
        var _data = this.props.ownedFiles;
        for (var _i = 0; _i < _data.length; _i++) {
          if (_data[_i].id === id) {
            this.props.currentFile = _data[_i];
            return;
          }
        }
      }
...
//# sourceMappingURL=0.57b201f236db2db32fd1.hot-update.js.map