...
var PapaParse = __webpack_require__(800);

module.exports = Papa.parse(file, {
  header: true,
  dynamicTyping: true,
...
!function (a, b) {
	 true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (b),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && "undefined" != typeof exports ? module.exports = b() : a.Papa = b();
}(undefined, function () {
	"use strict";
	function a(a, b) {
...
//# sourceMappingURL=0.5bf1b1759d5b3c8e5330.hot-update.js.map