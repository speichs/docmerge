...
function fetchUser(user) {
  return function (dispatch) {
    ...
    _axios2.default.post('file', user).then(function (response) {
      dispatch({ type: "LOGIN_USER_FULFILLED" }, payload);
    }).catch(function (err) {
      dispatch({ type: "LOGIN_USE_REJECTED" }, payload);
    });
  };
}
...
//# sourceMappingURL=0.c25491db2361cbc66dd6.hot-update.js.map